...
const createUserTable = db.prepare("CREATE TABLE IF NOT EXISTS users(id INTEGER PRIMARY KEY, first_name TEXT, last_name TEXT, pid INTEGER UNIQUE, username TEXT NOT NULL UNIQUE, password TEXT NOT NULL, admin INTEGER DEFAULT 0)");
